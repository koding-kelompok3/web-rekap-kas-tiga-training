...
<?php $__env->startSection('bendahara', 'active'); ?>
                        ...
                        <table class="table table-striped table-hover" id="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/admin/user/show/<?php echo e($u->id); ?>">
                                            <?php echo e($u->name); ?>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="button-show btn btn-xs btn-primary waves-effect" data-id="<?php echo e($u->id); ?>" data-toggle="modal" data-target="#modalShow">
                                            <i class="material-icons">visibility</i>
                                        </button>

                                        <button type="button" data-id="<?php echo e($u->id); ?>" class="button-edit btn btn-xs btn-warning waves-effect" data-toggle="modal" data-target="#modalEdit">
                                            <i class="material-icons">create</i>
                                        </button>

                                        <button type="button" data-id="<?php echo e($u->id); ?>" class="button-delete btn btn-xs btn-danger waves-effect">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Downloads\pengkodean\Uang-Kas\resources\views/admin/user/index.blade.php ENDPATH**/ ?>