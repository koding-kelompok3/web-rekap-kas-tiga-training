...
<?php $__env->startSection('siswa', 'active-nav'); ?>
            ...
            <table class="table table-hover mt-3" id="myTable">
                ...
                <tbody>
                    ...
                    <tr id="myTR">
                        ...
                        <td> <?php echo e($s->jk == 'L' ? "Laki Laki" : "Perempuan"); ?> </td>
                        <td><?php echo e(\Carbon\Carbon::parse($s->tanggal_lahir)->translatedFormat('d/M/Y')); ?></td>
                        <!-- <td>
                            <button tabindex="0" type="button" class="btn btn-primary btn-sm" data-container="body" data-toggle="popover" title="JK | Tanggal Lahir" data-trigger="focus" data-placement="top" data-content="
                                    <?php if($s->jk == 'L'): ?> Laki Laki
                                    <?php else: ?> Perempuan <?php endif; ?>
                                    |
                                    <?php echo e(date('d-M-Y', strtotime($s->tanggal_lahir))); ?>
                        ...
                        <td class="text-center" style="width: 50px;">
                            <a href="javascript:void(0)" class="btn btn-sm btn-danger button-delete" data-id="<?php echo e($s->id); ?>">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="kelas" type="text" name="kelas" class="form-control" value="<?php echo e(Auth::user()->kelas); ?>" disabled>
                        </div>
                    </div>

                    <input type="hidden" name="users_id" id="users_id" value="<?php echo e(Auth::user()->id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Downloads\pengkodean\Uang-Kas\resources\views//user/siswa/index.blade.php ENDPATH**/ ?>