                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/user/pembayaran/store" method="POST">
                            ...
                            <input type="hidden" name="nama_siswa" value="<?php echo e($s->nama_siswa); ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <select id="siswa_id" name="siswa_id" class="form-control" required>
                                        ...
                                        <?php $__currentLoopData = $siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($s->id); ?>"><?php echo e($s->nama_siswa); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <input type="date" class="form-control"
                                        value="<?php echo e(date('Y-m-d', strtotime(Carbon\carbon::today()->toDateString()))); ?>"
                                        disabled>
                                </div>
                            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="/user/pembayaran/show/<?php echo e($s->id); ?>"><?php echo e($s->nama_siswa); ?></a>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Downloads\pengkodean\Uang-Kas\resources\views/user/pembayaran/index.blade.php ENDPATH**/ ?>