    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-4 float-right">
                ...
                <span>Kelas &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?php echo e(Auth::user()->kelas); ?></span>
            </div>
        </div>
        ...
        <div class="col-4 float-right">
            ...
            <br><br><br><br>
            <span class="float-right">Bendahara</span>
        </div>
...
</html><?php /**PATH C:\Users\User\Downloads\pengkodean\Uang-Kas\resources\views/user/pembayaran/kas-masuk-pdf.blade.php ENDPATH**/ ?>