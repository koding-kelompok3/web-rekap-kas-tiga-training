...
<body>
    ...
    <div class="container-fluid mt-4">
        ...
        <div class="row color-fff1e1">
            <div class="col-sm-7">
                <img src="{{ asset('img/home/bg-new.png') }}" width="70%">
            </div>
            <div class="col-sm-5">
                <h2 class="text">FITUR YANG ADA</h2>
                <div class="card-content row">
                    <div class="col-2">
                        <img class="icon" src="{{ asset('img/home/icon/4.png') }}"width="100%">
                    </div>
                    <div class="col-10">
                ...
                <div class="card-content row">
                    <div class="col-2">
                        <img class="icon" src="{{ asset('img/home/icon/5.png') }}"width="100%">
                    </div>
                    <div class="col-10">
                ...
                <div class="card-content row mb-5">
                    <div class="col-2">
                        <img class="icon" src="{{ asset('img/home/icon/6.png') }}"width="100%">
                    </div>
                    <div class="col-10">
